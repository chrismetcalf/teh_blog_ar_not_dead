<!-- This theme doesn't use a sidebar, but the original boxy but good sidebar has been left intact below in case you'd like to try your hand at integrating it. -->

<!--
<div id="sidebar_container">

    <div class="ad_container">
	    <p><a href="http://www.sweetcron.com"><img src="<?php echo $this->config->item('theme_folder')?>images/ad.jpg" alt="" /></a></p>
    </div>
