...
<div class="accordion">
	...
	<div id="profile">
		...
		<img src="<?php echo $this->config->item('theme_folder')?>i/profile-blank.png" alt="<?php echo $this->config->item('lifestream_title')?>" id="profile-pic" />
		...
		<div id="profile-feeds">
			...
			<p class="facebook"><a href="#FACEBOOK">Add me on Facebook</a></p>
			<p class="linkedin"><a href="#LINKEDIN">Connect on LinkedIn</a></p>
		</div>
		<div id="profile-tags">
			<ul>
				<li>My tags:</li>
